!(function (e, n) {
    ...
    return (t, i, s) => {
      ...
      if (i.async)
        return Promise.resolve(i.hooks ? i.hooks.preprocess(t) : t)
          ...
          .then((e) =>
            i.walkTokens
              ? Promise.all(N.walkTokens(e, i.walkTokens)).then(() => e)
              : e,
          )
          .then((e) => n(e, i))
  ...
  (N.options = N.setOptions =
    function (e) {
      var t;
      return (
        (N.defaults = { ...N.defaults, ...e }), (t = N.defaults), (n = t), N
      );
    }),
    (N.getDefaults = e),
    (N.defaults = n),
    (N.use = function (...e) {
      ...
      e.forEach((e) => {
        const t = { ...e };
        if (
          ((t.async = N.defaults.async || t.async || !1),
          e.extensions &&
        ...
        if (e.tokenizer) {
          const n = N.defaults.tokenizer || new _();
        ...
        if (e.hooks) {
          const n = N.defaults.hooks || new q();
    ...
    (N.walkTokens = function (e, n) {
      let t = [];
      for (const i of e)
        switch (((t = t.concat(n.call(N, i))), i.type)) {
          case "table":
            for (const e of i.header) t = t.concat(N.walkTokens(e.tokens, n));
            for (const e of i.rows)
              for (const i of e) t = t.concat(N.walkTokens(i.tokens, n));
            break;
          case "list":
            t = t.concat(N.walkTokens(i.items, n));
            break;
          default:
            N.defaults.extensions &&
            N.defaults.extensions.childTokens &&
            N.defaults.extensions.childTokens[i.type]
              ? N.defaults.extensions.childTokens[i.type].forEach(function (e) {
                  t = t.concat(N.walkTokens(i[e], n));
                })
              : i.tokens && (t = t.concat(N.walkTokens(i.tokens, n)));
        }
      return t;
    }),
