              ...
              t.preventDefault(),
                (function () {
                  ...
                  o &&
                    ...
                    o.length > i && (e.slide(o[i].h, o[i].v), i++));
                })(),
                (l = !1);
            else l = !0;
          },
    ...
    function f(t, n) {
      ...
      (this.setRegex = function (e) {
          ...
          if (null != t && t && d && !l.test(t.nodeName)) {
            ...
            if (3 == t.nodeType)
              if ((o = t.nodeValue) && (f = d.exec(o))) {
                ...
                y || c.push(p),
                  r[f[0].toLowerCase()] ||
                    (r[f[0].toLowerCase()] = s[a++ % s.length]);
                var g = document.createElement(i);
                g.appendChild(document.createTextNode(f[0])),
                  (g.style.backgroundColor = r[f[0].toLowerCase()]),
        ...
        (this.apply = function (e) {
          if (null != e && e)
            return this.remove(), this.setRegex(e), this.hiliteWords(o), c;
        });
    }
    return {
      id: "search",
